...
for epoch in range(STAGE_1_EPOCHS):
    ...
    if val_acc > best_val_acc:
        ...
        model_save_path = os.path.join(ROOT_DIR, "outputs/models/efficientnet_b0_finetuned_best.pth")
...
# Save to CSV
metrics_csv_path = os.path.join(ROOT_DIR, "outputs/logs/efficientnet_b0_finetuned_metrics.csv")
